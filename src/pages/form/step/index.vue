    ...
    <div class="form-step-container">
      ...
      <t-card :bordered="false">
        <t-steps class="step-container" :current="1" status="process">
          ...
          <t-step-item title="电子信息" content="如有疑问联系客服" />
      ...
      >
        ...
        <t-form-item label="地址" name="address">
          <t-input v-model="formData2.address" :style="{ width: '480px' }" placeholder="请输入地址" />
        </t-form-item>
        ...
        <t-form-item label="邮箱" name="email">
          <t-input v-model="formData2.email" :style="{ width: '480px' }" placeholder="请输入邮箱" />
        </t-form-item>
        <t-form-item label="手机号" name="tel">
          <t-input v-model="formData2.tel" :style="{ width: '480px' }" placeholder="请输入手机号" />
        </t-form-item>
        <t-form-item>
