<template>
  <t-card :bordered="false">
    <t-row>
      <t-col :xs="12" :xl="9">
        <t-card :bordered="false" title="出入库概览" subtitle="(件)" class="dashboard-overview-card overview-panel">
          <template #actions>
            <t-date-range-picker
...
const renderStokeChart = () => {
  if (!stokeContainer) {
    stokeContainer = document.getElementById('stokeContainer') as HTMLElement;
  }
